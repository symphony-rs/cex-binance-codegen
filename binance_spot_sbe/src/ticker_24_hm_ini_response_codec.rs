...
pub mod encoder {
    ...
    impl<'a> Ticker24hMiniResponseEncoder<'a> {
        ...
        #[inline]
        pub fn tickers_encoder(self, count: u32, tickers_encoder: TickersEncoder<Self>) -> TickersEncoder<Self> {
    ...
    impl<'a, P> Writer<'a> for TickersEncoder<P> where P: Writer<'a> + Default {
        #[inline]
        fn get_buf_mut(&mut self) -> &mut WriteBuf<'a> {
    ...
    impl<'a, P> Encoder<'a> for TickersEncoder<P> where P: Encoder<'a> + Default {
        #[inline]
        fn get_limit(&self) -> usize {
    ...
    impl<'a, P> TickersEncoder<P> where P: Encoder<'a> + Default {
        #[inline]
        pub fn wrap(
            mut self,
            mut parent: P,
...
pub mod decoder {
    ...
    impl ActingVersion for Ticker24hMiniResponseDecoder<'_> {
        #[inline]
    ...
    impl<'a, P> ActingVersion for TickersDecoder<P> where P: Reader<'a> + ActingVersion + Default {
        #[inline]
        fn acting_version(&self) -> u16 {
    ...
    impl<'a, P> Reader<'a> for TickersDecoder<P> where P: Reader<'a> + Default {
        #[inline]
        fn get_buf(&self) -> &ReadBuf<'a> {
    ...
    impl<'a, P> Decoder<'a> for TickersDecoder<P> where P: Decoder<'a> + ActingVersion + Default {
        #[inline]
        fn get_limit(&self) -> usize {
            self.parent.as_ref().expect("parent missing").get_limit()
        }
    ...
    impl<'a, P> TickersDecoder<P> where P: Decoder<'a> + ActingVersion + Default {
        pub fn wrap(
            mut self,
            mut parent: P,
        ) -> Self {
