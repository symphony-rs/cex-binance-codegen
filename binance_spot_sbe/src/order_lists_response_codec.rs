...
pub mod encoder {
    ...
    impl<'a> OrderListsResponseEncoder<'a> {
        ...
        #[inline]
        pub fn order_lists_encoder(self, count: u32, order_lists_encoder: OrderListsEncoder<Self>) -> OrderListsEncoder<Self> {
    ...
    impl<'a, P> Writer<'a> for OrderListsEncoder<P> where P: Writer<'a> + Default {
        #[inline]
        fn get_buf_mut(&mut self) -> &mut WriteBuf<'a> {
    ...
    impl<'a, P> Encoder<'a> for OrderListsEncoder<P> where P: Encoder<'a> + Default {
        #[inline]
        fn get_limit(&self) -> usize {
    ...
    impl<'a, P> OrderListsEncoder<P> where P: Encoder<'a> + Default {
        #[inline]
        pub fn wrap(
            mut self,
            mut parent: P,
        ...
        /// GROUP ENCODER (id=100)
        #[inline]
        pub fn orders_encoder(self, count: u32, orders_encoder: OrdersEncoder<Self>) -> OrdersEncoder<Self> {
...
pub mod decoder {
    ...
    impl ActingVersion for OrderListsResponseDecoder<'_> {
        #[inline]
    ...
    impl<'a, P> ActingVersion for OrderListsDecoder<P> where P: Reader<'a> + ActingVersion + Default {
        #[inline]
        fn acting_version(&self) -> u16 {
    ...
    impl<'a, P> Reader<'a> for OrderListsDecoder<P> where P: Reader<'a> + Default {
        #[inline]
        fn get_buf(&self) -> &ReadBuf<'a> {
    ...
    impl<'a, P> Decoder<'a> for OrderListsDecoder<P> where P: Decoder<'a> + ActingVersion + Default {
        #[inline]
        fn get_limit(&self) -> usize {
            self.parent.as_ref().expect("parent missing").get_limit()
        }
    ...
    impl<'a, P> OrderListsDecoder<P> where P: Decoder<'a> + ActingVersion + Default {
        pub fn wrap(
            mut self,
            mut parent: P,
        ) -> Self {
        ...
        /// group token - Token{signal=BEGIN_GROUP, name='orderLists', referencedName='null', description='null', packageName='null', id=100, version=0, deprecated=0, encodedLength=19, offset=0, componentTokenCount=70, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='null'}}
        #[inline]
        pub fn parent(&mut self) -> SbeResult<P> {
            self.parent.take().ok_or(SbeErr::ParentNotSet)
        }
