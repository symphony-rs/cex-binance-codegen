...
pub use decoder::MaxAssetFilterDecoder;
pub use encoder::MaxAssetFilterEncoder;
...
pub mod encoder {
    ...
    pub struct MaxAssetFilterEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Encoder<'a> for MaxAssetFilterEncoder<'a> {
        #[inline]
    ...
    impl<'a> MaxAssetFilterEncoder<'a> {
...
pub mod decoder {
    ...
    pub struct MaxAssetFilterDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for MaxAssetFilterDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for MaxAssetFilterDecoder<'a> {
        #[inline]
    ...
    impl<'a> MaxAssetFilterDecoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
        ...
        pub fn filter_type(&self) -> filter_type::FilterType {
            filter_type::FilterType::MaxAsset
        }
