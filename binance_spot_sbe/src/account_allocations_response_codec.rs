...
pub mod encoder {
    ...
    impl<'a> AccountAllocationsResponseEncoder<'a> {
        ...
        #[inline]
        pub fn allocations_encoder(self, count: u32, allocations_encoder: AllocationsEncoder<Self>) -> AllocationsEncoder<Self> {
...
pub mod decoder {
    ...
    impl<'a, P> Reader<'a> for AllocationsDecoder<P> where P: Reader<'a> + Default {
        #[inline]
        fn get_buf(&self) -> &ReadBuf<'a> {
