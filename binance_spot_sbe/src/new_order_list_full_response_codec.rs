...
pub mod encoder {
    ...
    impl<'a> NewOrderListFullResponseEncoder<'a> {
        ...
        #[inline]
        pub fn order_reports_encoder(self, count: u16, order_reports_encoder: OrderReportsEncoder<Self>) -> OrderReportsEncoder<Self> {
    ...
    impl<'a, P> Writer<'a> for OrderReportsEncoder<P> where P: Writer<'a> + Default {
        #[inline]
        fn get_buf_mut(&mut self) -> &mut WriteBuf<'a> {
            if let Some(parent) = self.parent.as_mut() {
                parent.get_buf_mut()
    ...
    impl<'a, P> Encoder<'a> for OrderReportsEncoder<P> where P: Encoder<'a> + Default {
        #[inline]
        fn get_limit(&self) -> usize {
            self.parent.as_ref().expect("parent missing").get_limit()
        }
    ...
    impl<'a, P> OrderReportsEncoder<P> where P: Encoder<'a> + Default {
        #[inline]
        pub fn wrap(
            mut self,
            mut parent: P,
        ...
        /// REQUIRED enum
        #[inline]
        pub fn self_trade_prevention_mode(&mut self, value: self_trade_prevention_mode::SelfTradePreventionMode) {
        ...
        /// GROUP ENCODER (id=100)
        #[inline]
        pub fn fills_encoder(self, count: u32, fills_encoder: FillsEncoder<Self>) -> FillsEncoder<Self> {
            fills_encoder.wrap(self, count)
        }

        /// GROUP ENCODER (id=101)
        #[inline]
        pub fn prevented_matches_encoder(self, count: u32, prevented_matches_encoder: PreventedMatchesEncoder<Self>) -> PreventedMatchesEncoder<Self> {
    ...
    impl<'a, P> Writer<'a> for FillsEncoder<P> where P: Writer<'a> + Default {
        #[inline]
        fn get_buf_mut(&mut self) -> &mut WriteBuf<'a> {
            if let Some(parent) = self.parent.as_mut() {
                parent.get_buf_mut()
    ...
    impl<'a, P> Encoder<'a> for FillsEncoder<P> where P: Encoder<'a> + Default {
        #[inline]
        fn get_limit(&self) -> usize {
            self.parent.as_ref().expect("parent missing").get_limit()
        }
    ...
    impl<'a, P> FillsEncoder<P> where P: Encoder<'a> + Default {
        #[inline]
        pub fn wrap(
            mut self,
            mut parent: P,
    ...
    impl<'a, P> Writer<'a> for PreventedMatchesEncoder<P> where P: Writer<'a> + Default {
        #[inline]
        fn get_buf_mut(&mut self) -> &mut WriteBuf<'a> {
            if let Some(parent) = self.parent.as_mut() {
                parent.get_buf_mut()
    ...
    impl<'a, P> Encoder<'a> for PreventedMatchesEncoder<P> where P: Encoder<'a> + Default {
        #[inline]
        fn get_limit(&self) -> usize {
            self.parent.as_ref().expect("parent missing").get_limit()
        }
    ...
    impl<'a, P> PreventedMatchesEncoder<P> where P: Encoder<'a> + Default {
        #[inline]
        pub fn wrap(
            mut self,
            mut parent: P,
...
pub mod decoder {
    ...
    impl<'a, P> ActingVersion for OrderReportsDecoder<P> where P: Reader<'a> + ActingVersion + Default {
        #[inline]
        fn acting_version(&self) -> u16 {
            self.parent.as_ref().unwrap().acting_version()
        }
    ...
    impl<'a, P> Reader<'a> for OrderReportsDecoder<P> where P: Reader<'a> + Default {
        #[inline]
        fn get_buf(&self) -> &ReadBuf<'a> {
            self.parent.as_ref().expect("parent missing").get_buf()
        }
    ...
    impl<'a, P> Decoder<'a> for OrderReportsDecoder<P> where P: Decoder<'a> + ActingVersion + Default {
        #[inline]
        fn get_limit(&self) -> usize {
            self.parent.as_ref().expect("parent missing").get_limit()
        }
    ...
    impl<'a, P> OrderReportsDecoder<P> where P: Decoder<'a> + ActingVersion + Default {
        pub fn wrap(
            mut self,
            mut parent: P,
        ) -> Self {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn self_trade_prevention_mode(&self) -> self_trade_prevention_mode::SelfTradePreventionMode {
    ...
    impl<'a, P> ActingVersion for FillsDecoder<P> where P: Reader<'a> + ActingVersion + Default {
        #[inline]
        fn acting_version(&self) -> u16 {
            self.parent.as_ref().unwrap().acting_version()
        }
    ...
    impl<'a, P> Reader<'a> for FillsDecoder<P> where P: Reader<'a> + Default {
        #[inline]
        fn get_buf(&self) -> &ReadBuf<'a> {
            self.parent.as_ref().expect("parent missing").get_buf()
        }
    ...
    impl<'a, P> Decoder<'a> for FillsDecoder<P> where P: Decoder<'a> + ActingVersion + Default {
        #[inline]
        fn get_limit(&self) -> usize {
            self.parent.as_ref().expect("parent missing").get_limit()
        }
    ...
    impl<'a, P> FillsDecoder<P> where P: Decoder<'a> + ActingVersion + Default {
        pub fn wrap(
            mut self,
            mut parent: P,
        ) -> Self {
    ...
    impl<'a, P> ActingVersion for PreventedMatchesDecoder<P> where P: Reader<'a> + ActingVersion + Default {
        #[inline]
        fn acting_version(&self) -> u16 {
            self.parent.as_ref().unwrap().acting_version()
        }
    ...
    impl<'a, P> Reader<'a> for PreventedMatchesDecoder<P> where P: Reader<'a> + Default {
        #[inline]
        fn get_buf(&self) -> &ReadBuf<'a> {
            self.parent.as_ref().expect("parent missing").get_buf()
        }
    ...
    impl<'a, P> Decoder<'a> for PreventedMatchesDecoder<P> where P: Decoder<'a> + ActingVersion + Default {
        #[inline]
        fn get_limit(&self) -> usize {
            self.parent.as_ref().expect("parent missing").get_limit()
        }
    ...
    impl<'a, P> PreventedMatchesDecoder<P> where P: Decoder<'a> + ActingVersion + Default {
        pub fn wrap(
            mut self,
            mut parent: P,
        ) -> Self {
