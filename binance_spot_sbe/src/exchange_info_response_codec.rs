...
pub mod encoder {
    ...
    impl<'a> ExchangeInfoResponseEncoder<'a> {
        ...
        #[inline]
        pub fn rate_limits_encoder(self, count: u32, rate_limits_encoder: RateLimitsEncoder<Self>) -> RateLimitsEncoder<Self> {
            rate_limits_encoder.wrap(self, count)
        }

        /// GROUP ENCODER (id=101)
        #[inline]
        pub fn exchange_filters_encoder(self, count: u32, exchange_filters_encoder: ExchangeFiltersEncoder<Self>) -> ExchangeFiltersEncoder<Self> {
            exchange_filters_encoder.wrap(self, count)
        }

        /// GROUP ENCODER (id=102)
        #[inline]
        pub fn symbols_encoder(self, count: u32, symbols_encoder: SymbolsEncoder<Self>) -> SymbolsEncoder<Self> {
            symbols_encoder.wrap(self, count)
        }

        /// GROUP ENCODER (id=103)
        #[inline]
        pub fn sors_encoder(self, count: u32, sors_encoder: SorsEncoder<Self>) -> SorsEncoder<Self> {
    ...
    impl<'a, P> Writer<'a> for RateLimitsEncoder<P> where P: Writer<'a> + Default {
        #[inline]
        fn get_buf_mut(&mut self) -> &mut WriteBuf<'a> {
    ...
    impl<'a, P> Encoder<'a> for RateLimitsEncoder<P> where P: Encoder<'a> + Default {
        #[inline]
        fn get_limit(&self) -> usize {
    ...
    impl<'a, P> RateLimitsEncoder<P> where P: Encoder<'a> + Default {
        #[inline]
        pub fn wrap(
            mut self,
            mut parent: P,
    ...
    impl<'a, P> Writer<'a> for ExchangeFiltersEncoder<P> where P: Writer<'a> + Default {
        #[inline]
        fn get_buf_mut(&mut self) -> &mut WriteBuf<'a> {
            if let Some(parent) = self.parent.as_mut() {
                parent.get_buf_mut()
    ...
    impl<'a, P> Encoder<'a> for ExchangeFiltersEncoder<P> where P: Encoder<'a> + Default {
        #[inline]
        fn get_limit(&self) -> usize {
            self.parent.as_ref().expect("parent missing").get_limit()
        }
    ...
    impl<'a, P> ExchangeFiltersEncoder<P> where P: Encoder<'a> + Default {
        #[inline]
        pub fn wrap(
            mut self,
            mut parent: P,
    ...
    impl<'a, P> Writer<'a> for SymbolsEncoder<P> where P: Writer<'a> + Default {
        #[inline]
        fn get_buf_mut(&mut self) -> &mut WriteBuf<'a> {
            if let Some(parent) = self.parent.as_mut() {
                parent.get_buf_mut()
    ...
    impl<'a, P> Encoder<'a> for SymbolsEncoder<P> where P: Encoder<'a> + Default {
        #[inline]
        fn get_limit(&self) -> usize {
            self.parent.as_ref().expect("parent missing").get_limit()
        }
    ...
    impl<'a, P> SymbolsEncoder<P> where P: Encoder<'a> + Default {
        #[inline]
        pub fn wrap(
            mut self,
            mut parent: P,
        ...
        /// REQUIRED enum
        #[inline]
        pub fn default_self_trade_prevention_mode(&mut self, value: self_trade_prevention_mode::SelfTradePreventionMode) {
            let offset = self.offset + 16;
            self.get_buf_mut().put_u8_at(offset, value as u8)
        }

        #[inline]
        pub fn allowed_self_trade_prevention_modes(&mut self, value: allowed_self_trade_prevention_modes::AllowedSelfTradePreventionModes) {
    ...
    impl<'a, P> Writer<'a> for FiltersEncoder<P> where P: Writer<'a> + Default {
        #[inline]
        fn get_buf_mut(&mut self) -> &mut WriteBuf<'a> {
            if let Some(parent) = self.parent.as_mut() {
                parent.get_buf_mut()
    ...
    impl<'a, P> Encoder<'a> for FiltersEncoder<P> where P: Encoder<'a> + Default {
        #[inline]
        fn get_limit(&self) -> usize {
            self.parent.as_ref().expect("parent missing").get_limit()
        }
    ...
    impl<'a, P> FiltersEncoder<P> where P: Encoder<'a> + Default {
        #[inline]
        pub fn wrap(
            mut self,
            mut parent: P,
    ...
    impl<'a, P> Writer<'a> for PermissionSetsEncoder<P> where P: Writer<'a> + Default {
        #[inline]
        fn get_buf_mut(&mut self) -> &mut WriteBuf<'a> {
            if let Some(parent) = self.parent.as_mut() {
                parent.get_buf_mut()
    ...
    impl<'a, P> Encoder<'a> for PermissionSetsEncoder<P> where P: Encoder<'a> + Default {
        #[inline]
        fn get_limit(&self) -> usize {
            self.parent.as_ref().expect("parent missing").get_limit()
        }
    ...
    impl<'a, P> PermissionSetsEncoder<P> where P: Encoder<'a> + Default {
        #[inline]
        pub fn wrap(
            mut self,
            mut parent: P,
    ...
    impl<'a, P> Writer<'a> for PermissionsEncoder<P> where P: Writer<'a> + Default {
        #[inline]
        fn get_buf_mut(&mut self) -> &mut WriteBuf<'a> {
            if let Some(parent) = self.parent.as_mut() {
                parent.get_buf_mut()
    ...
    impl<'a, P> Encoder<'a> for PermissionsEncoder<P> where P: Encoder<'a> + Default {
        #[inline]
        fn get_limit(&self) -> usize {
            self.parent.as_ref().expect("parent missing").get_limit()
        }
    ...
    impl<'a, P> PermissionsEncoder<P> where P: Encoder<'a> + Default {
        #[inline]
        pub fn wrap(
            mut self,
            mut parent: P,
    ...
    impl<'a, P> Writer<'a> for SorsEncoder<P> where P: Writer<'a> + Default {
        #[inline]
        fn get_buf_mut(&mut self) -> &mut WriteBuf<'a> {
            if let Some(parent) = self.parent.as_mut() {
                parent.get_buf_mut()
    ...
    impl<'a, P> Encoder<'a> for SorsEncoder<P> where P: Encoder<'a> + Default {
        #[inline]
        fn get_limit(&self) -> usize {
            self.parent.as_ref().expect("parent missing").get_limit()
        }
    ...
    impl<'a, P> SorsEncoder<P> where P: Encoder<'a> + Default {
        #[inline]
        pub fn wrap(
            mut self,
            mut parent: P,
        ...
        /// GROUP ENCODER (id=1)
        #[inline]
        pub fn sor_symbols_encoder(self, count: u32, sor_symbols_encoder: SorSymbolsEncoder<Self>) -> SorSymbolsEncoder<Self> {
    ...
    impl<'a, P> Writer<'a> for SorSymbolsEncoder<P> where P: Writer<'a> + Default {
        #[inline]
        fn get_buf_mut(&mut self) -> &mut WriteBuf<'a> {
            if let Some(parent) = self.parent.as_mut() {
                parent.get_buf_mut()
    ...
    impl<'a, P> Encoder<'a> for SorSymbolsEncoder<P> where P: Encoder<'a> + Default {
        #[inline]
        fn get_limit(&self) -> usize {
            self.parent.as_ref().expect("parent missing").get_limit()
        }
    ...
    impl<'a, P> SorSymbolsEncoder<P> where P: Encoder<'a> + Default {
        #[inline]
        pub fn wrap(
            mut self,
            mut parent: P,
...
pub mod decoder {
    ...
    impl<'a, P> ActingVersion for RateLimitsDecoder<P> where P: Reader<'a> + ActingVersion + Default {
        #[inline]
        fn acting_version(&self) -> u16 {
    ...
    impl<'a, P> Reader<'a> for RateLimitsDecoder<P> where P: Reader<'a> + Default {
        #[inline]
        fn get_buf(&self) -> &ReadBuf<'a> {
    ...
    impl<'a, P> Decoder<'a> for RateLimitsDecoder<P> where P: Decoder<'a> + ActingVersion + Default {
        #[inline]
        fn get_limit(&self) -> usize {
            self.parent.as_ref().expect("parent missing").get_limit()
        }
    ...
    impl<'a, P> RateLimitsDecoder<P> where P: Decoder<'a> + ActingVersion + Default {
        pub fn wrap(
            mut self,
            mut parent: P,
        ) -> Self {
    ...
    impl<'a, P> ActingVersion for ExchangeFiltersDecoder<P> where P: Reader<'a> + ActingVersion + Default {
        #[inline]
        fn acting_version(&self) -> u16 {
            self.parent.as_ref().unwrap().acting_version()
        }
    ...
    impl<'a, P> Reader<'a> for ExchangeFiltersDecoder<P> where P: Reader<'a> + Default {
        #[inline]
        fn get_buf(&self) -> &ReadBuf<'a> {
            self.parent.as_ref().expect("parent missing").get_buf()
        }
    ...
    impl<'a, P> Decoder<'a> for ExchangeFiltersDecoder<P> where P: Decoder<'a> + ActingVersion + Default {
        #[inline]
        fn get_limit(&self) -> usize {
            self.parent.as_ref().expect("parent missing").get_limit()
        }
    ...
    impl<'a, P> ExchangeFiltersDecoder<P> where P: Decoder<'a> + ActingVersion + Default {
        pub fn wrap(
            mut self,
            mut parent: P,
        ) -> Self {
    ...
    impl<'a, P> ActingVersion for SymbolsDecoder<P> where P: Reader<'a> + ActingVersion + Default {
        #[inline]
        fn acting_version(&self) -> u16 {
            self.parent.as_ref().unwrap().acting_version()
        }
    ...
    impl<'a, P> Reader<'a> for SymbolsDecoder<P> where P: Reader<'a> + Default {
        #[inline]
        fn get_buf(&self) -> &ReadBuf<'a> {
            self.parent.as_ref().expect("parent missing").get_buf()
        }
    ...
    impl<'a, P> Decoder<'a> for SymbolsDecoder<P> where P: Decoder<'a> + ActingVersion + Default {
        #[inline]
        fn get_limit(&self) -> usize {
            self.parent.as_ref().expect("parent missing").get_limit()
        }
    ...
    impl<'a, P> SymbolsDecoder<P> where P: Decoder<'a> + ActingVersion + Default {
        pub fn wrap(
            mut self,
            mut parent: P,
        ) -> Self {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn default_self_trade_prevention_mode(&self) -> self_trade_prevention_mode::SelfTradePreventionMode {
            self.get_buf().get_u8_at(self.offset + 16).into()
        }

        /// BIT SET DECODER
        #[inline]
        pub fn allowed_self_trade_prevention_modes(&self) -> allowed_self_trade_prevention_modes::AllowedSelfTradePreventionModes {
            allowed_self_trade_prevention_modes::AllowedSelfTradePreventionModes::new(self.get_buf().get_u8_at(self.offset + 17))
        }
    ...
    impl<'a, P> ActingVersion for FiltersDecoder<P> where P: Reader<'a> + ActingVersion + Default {
        #[inline]
        fn acting_version(&self) -> u16 {
            self.parent.as_ref().unwrap().acting_version()
        }
    ...
    impl<'a, P> Reader<'a> for FiltersDecoder<P> where P: Reader<'a> + Default {
        #[inline]
        fn get_buf(&self) -> &ReadBuf<'a> {
            self.parent.as_ref().expect("parent missing").get_buf()
        }
    ...
    impl<'a, P> Decoder<'a> for FiltersDecoder<P> where P: Decoder<'a> + ActingVersion + Default {
        #[inline]
        fn get_limit(&self) -> usize {
            self.parent.as_ref().expect("parent missing").get_limit()
        }
    ...
    impl<'a, P> FiltersDecoder<P> where P: Decoder<'a> + ActingVersion + Default {
        pub fn wrap(
            mut self,
            mut parent: P,
        ) -> Self {
    ...
    impl<'a, P> ActingVersion for PermissionSetsDecoder<P> where P: Reader<'a> + ActingVersion + Default {
        #[inline]
        fn acting_version(&self) -> u16 {
            self.parent.as_ref().unwrap().acting_version()
        }
    ...
    impl<'a, P> Reader<'a> for PermissionSetsDecoder<P> where P: Reader<'a> + Default {
        #[inline]
        fn get_buf(&self) -> &ReadBuf<'a> {
            self.parent.as_ref().expect("parent missing").get_buf()
        }
    ...
    impl<'a, P> Decoder<'a> for PermissionSetsDecoder<P> where P: Decoder<'a> + ActingVersion + Default {
        #[inline]
        fn get_limit(&self) -> usize {
            self.parent.as_ref().expect("parent missing").get_limit()
        }
    ...
    impl<'a, P> PermissionSetsDecoder<P> where P: Decoder<'a> + ActingVersion + Default {
        pub fn wrap(
            mut self,
            mut parent: P,
        ) -> Self {
    ...
    impl<'a, P> ActingVersion for PermissionsDecoder<P> where P: Reader<'a> + ActingVersion + Default {
        #[inline]
        fn acting_version(&self) -> u16 {
            self.parent.as_ref().unwrap().acting_version()
        }
    ...
    impl<'a, P> Reader<'a> for PermissionsDecoder<P> where P: Reader<'a> + Default {
        #[inline]
        fn get_buf(&self) -> &ReadBuf<'a> {
            self.parent.as_ref().expect("parent missing").get_buf()
        }
    ...
    impl<'a, P> Decoder<'a> for PermissionsDecoder<P> where P: Decoder<'a> + ActingVersion + Default {
        #[inline]
        fn get_limit(&self) -> usize {
            self.parent.as_ref().expect("parent missing").get_limit()
        }
    ...
    impl<'a, P> PermissionsDecoder<P> where P: Decoder<'a> + ActingVersion + Default {
        pub fn wrap(
            mut self,
            mut parent: P,
        ) -> Self {
    ...
    impl<'a, P> ActingVersion for SorsDecoder<P> where P: Reader<'a> + ActingVersion + Default {
        #[inline]
        fn acting_version(&self) -> u16 {
            self.parent.as_ref().unwrap().acting_version()
        }
    ...
    impl<'a, P> Reader<'a> for SorsDecoder<P> where P: Reader<'a> + Default {
        #[inline]
        fn get_buf(&self) -> &ReadBuf<'a> {
            self.parent.as_ref().expect("parent missing").get_buf()
        }
    ...
    impl<'a, P> Decoder<'a> for SorsDecoder<P> where P: Decoder<'a> + ActingVersion + Default {
        #[inline]
        fn get_limit(&self) -> usize {
            self.parent.as_ref().expect("parent missing").get_limit()
        }
    ...
    impl<'a, P> SorsDecoder<P> where P: Decoder<'a> + ActingVersion + Default {
        pub fn wrap(
            mut self,
            mut parent: P,
        ) -> Self {
    ...
    impl<'a, P> ActingVersion for SorSymbolsDecoder<P> where P: Reader<'a> + ActingVersion + Default {
        #[inline]
        fn acting_version(&self) -> u16 {
            self.parent.as_ref().unwrap().acting_version()
        }
    ...
    impl<'a, P> Reader<'a> for SorSymbolsDecoder<P> where P: Reader<'a> + Default {
        #[inline]
        fn get_buf(&self) -> &ReadBuf<'a> {
            self.parent.as_ref().expect("parent missing").get_buf()
        }
    ...
    impl<'a, P> Decoder<'a> for SorSymbolsDecoder<P> where P: Decoder<'a> + ActingVersion + Default {
        #[inline]
        fn get_limit(&self) -> usize {
            self.parent.as_ref().expect("parent missing").get_limit()
        }
    ...
    impl<'a, P> SorSymbolsDecoder<P> where P: Decoder<'a> + ActingVersion + Default {
        pub fn wrap(
            mut self,
            mut parent: P,
        ) -> Self {
